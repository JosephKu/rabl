module Rabl
  class Builder
    ...
    def child(data, options={}, &block)
      ...
      include_root = options[:object_root] if !!options[:object_root] == options[:object_root]
      ...
      if options[:root].is_a?(String)
        @_result[options[:root]] = self.object_to_hash(object, engine_options, &block)
      else
